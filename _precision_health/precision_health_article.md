...
Precision public health - if it is to succeed - will need to embrace an interdisciplinary approach.  That is, data to support research questions in this emerging field will need to come from the fields of statistics, geography, economics, sociology, health, biology, genetics, and ecology.  Naturally, this list is not exhaustive, simply a beginning. 
